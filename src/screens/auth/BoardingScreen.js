import { Compass, Landmark, Lightbulb, Rocket } from "lucide-react-native";
...
const slides = [
    {
        id: "1",
        icon: <Landmark size={48} color={COLORS.white} />,
    ...
    {
        id: "2",
        icon: <Compass size={48} color={COLORS.white} />,
    ...
    {
        id: "3",
        icon: <Lightbulb size={48} color={COLORS.white} />,
    ...
    {
        id: "4",
        icon: <Rocket size={48} color={COLORS.white} />,
...
export default function OnboardingScreen({ navigation }) {
    ...
    const finish = () => {
        navigation.navigate("LoanFinderScreen"); // Change to your main screen
    };
